...
namespace proTienda
{
    public partial class frmVentas : Form
    {
        ...
        void txtCANTIDAD_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            txtID_PRODUCTO.BackColor = Color.White;
        ...
        private void EncabezadosListaProductos()
        {
            ...
            lvProductos.Columns.Add("Descripción", 150,
                HorizontalAlignment.Left);
            lvProductos.Columns.Add("Existencia", 40,
                HorizontalAlignment.Right);
            lvProductos.Columns.Add("Precio", 45,
                HorizontalAlignment.Right);
        }
        ...
        private void Producto()
        {
            ...
            try
            {
                if (lvProductos.Items.Count != 0)
                {
                     ...
                     txtID_PRODUCTO.BackColor = Color.Yellow;
                }
        ...
        private void txtDESC_PRODUCTO_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.F5 || e.KeyCode == Keys.Enter)
            {
                ReadData(txtDESC_PRODUCTO.Text);
                lvProductos.Focus();
                ListViewItem myitem = lvProductos.Items[0] as ListViewItem;
                myitem.Focused = true;
