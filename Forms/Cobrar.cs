...
namespace proTienda
{
    public partial class Cobrar : Form
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            else if ((txtMotivo.Text == "") && (Convert.ToDouble(txtEfectivo.Text) <= varTotal))
            {
                MessageBox.Show("Debe Introducir una Motivo Valida", "Motivo Obligatorio");
            }
            else if ((txtMotivo.Text != "") && (Convert.ToDouble(txtEfectivo.Text) <= varTotal))
            {
                try
                {
                    ...
                    cmdInsert.CommandText = "UPDATE VENTAS  SET MOTIVO = '" + txtMotivo.Text + "' WHERE FOLIO = " + varFolio + "";                  
            ...
            {
                MessageBox.Show("Debe introducir una Cantidad Valida", "Faltan datos");
            }
