...
namespace proTienda
{
    ...
    {
        public ConsultaReporte(int folio)
        {
            InitializeComponent();
            CargaRegistro();
        ...
        public void CargaRegistro()
        {
            ...
            if (cnnReadData.State == ConnectionState.Open)
             ...
             OleDbCommand cmdReadData = new OleDbCommand("SELECT VENTAS.FOLIO, CAT_PRODUCTOS.DESC_PRODUCTO, DETALLE_VENTAS.CANTIDAD, DETALLE_VENTAS.P_UNITARIO, VENTAS.FECHA, VENTAS.USER_NAME , VENTAS.MOTIVO "+ 
        ...
        private void ConsultaReporte_Load(object sender, EventArgs e)
        {
